      ...
      <section className="flex min-h-screen flex-col px-6 py-8 sm:px-10 lg:px-16">
        ...
        <div className="flex flex-1 items-center">
          <div className="mx-auto w-full max-w-xl py-12">
            <div>
              <p className="text-sm font-semibold uppercase tracking-wide text-[#003fb1]">Welcome back</p>
              ...
              <p className="mt-4 max-w-lg text-lg leading-7 text-[#434654]">
                Sign in to manage reports, review matches, and continue safe item recovery.
              </p>
            </div>
            ...
            <form className="mt-10 space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between gap-4">
                <label className="flex items-center gap-3 text-sm font-medium text-[#434654]">
                  <input
                    type="checkbox"
                    checked={rememberMe}
                    onChange={(event) => setRememberMe(event.target.checked)}
                    className="h-5 w-5 rounded border-[#c3c5d7] text-[#003fb1] focus:ring-[#003fb1]"
                    disabled={isSubmitting}
                  />
                  Remember me
                </label>
                <a href="mailto:support@foundtrust.local?subject=Password%20reset%20request" className="text-sm font-semibold text-[#003fb1] hover:text-[#1a56db]">
                  Forgot password?
                </a>
              </div>
            ...
            <p className="mt-8 text-center text-base text-[#434654]">
              ...
              <Link to="/register" className="font-semibold text-[#003fb1] hover:text-[#1a56db]">
                Create an account
              </Link>
            </p>
          </div>
